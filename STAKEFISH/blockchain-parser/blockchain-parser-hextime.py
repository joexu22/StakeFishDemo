...
dirA = '/home/ubuntu/Desktop/Project/experiment/' # Directory where blk*.dat files are stored
#dirA = '/home/ubuntu/.bitcoin/blocks/'
#dirA = sys.argv[1]
dirB = '/home/ubuntu/Desktop/Project/experiment_out/' # Directory where to save parsing results
#dirA = sys.argv[2]
...
previousHexTime = "495FAB29" # Genesis Block
...
for i in fList:
    ...
    while f.tell() != fSize:
        ...
        if (int(tmpHex, 16) - int(previousHexTime, 16) > 7200):
            moreThanTwoHourCount = moreThanTwoHourCount + 1
            #resList.append('Prev = ' + str(datetime.datetime.fromtimestamp(int(previousHexTime, 16))))
            #resList.append('Next = ' + str(datetime.datetime.fromtimestamp(int(tmpHex, 16))))
        previousHexTime = tmpHex
...
f = open(dirB + nameRes, 'a')
f.write("At stack height " + str(stackHeight) + " there are ")
#f.write(str(moreThanTwoHourCount) + ' instances of blocks taking more than 2 hours\n')
f.close()