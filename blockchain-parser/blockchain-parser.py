...
dirA = '/home/ubuntu/Desktop/Project/blockchain-sample/' # Directory where blk*.dat files are stored
#dirA = sys.argv[1]
dirB = '/home/ubuntu/Desktop/Project/parsed-data/' # Directory where to save parsing results
#dirA = sys.argv[2]
